...
def save_evaluation_results(model_name, num_epochs, augmentations_str, batch_size, l2_reg, lr, max_lr, scheduler_type, test_metrics, dropout_p):

    model_info = f"{model_name}_{num_epochs}_{augmentations_str}_{batch_size}_{l2_reg}_{lr}_{max_lr}_{scheduler_type}_{dropout_p}"
...
def evaluate_model(model, test_loader, num_epochs, l2_reg=0.0001, lr=0.001, max_lr=0.003, scheduler_type="none", device=None, augmentations=None, dropout_p=0.5):
    ...
    save_evaluation_results(model.__class__.__name__, num_epochs, augmentations_str, test_loader.batch_size, l2_reg, lr, max_lr, scheduler_type, test_metrics, dropout_p)
