...
def run_test(batch_size = batch_size, lr=lr, epochs=epochs, l2_reg=l2_reg, augmentations=augmentations, scheduler_type=scheduler_type, dropout_p=dropout_p, i=1):
    ...
    evaluate_model(model_deep_cnn, test_loader, num_epochs=epochs, l2_reg=l2_reg, lr=lr, augmentations=augmentations, scheduler_type=scheduler_type, dropout_p=dropout_p)
    if i == 1:
        save_model(model_deep_cnn, "Deep_CNN_one_cycle_OK", epoch=epochs)
    else:
        save_model(model_deep_cnn, "Deep_CNN_step_decay_OK", epoch=epochs)
    ...
    evaluate_model(model_simple_cnn, test_loader, num_epochs=epochs, l2_reg=l2_reg, lr=lr, augmentations=augmentations, scheduler_type=scheduler_type, dropout_p=dropout_p)
    if i == 1:
        save_model(model_simple_cnn, "Simple_CNN_one_cycle_OK", epoch=epochs)
    save_model(model_simple_cnn, "Simple_CNN_step_decay_OK", epoch=epochs)
    ...
    evaluate_model(model_cnn_with_fc, test_loader, num_epochs=epochs, l2_reg=l2_reg, lr=lr, augmentations=augmentations, scheduler_type=scheduler_type, dropout_p=dropout_p)
    if i == 1:
        save_model(model_simple_cnn, "CNN_with_fc_one_cycle_OK", epoch=epochs)   
    else:
        save_model(model_simple_cnn, "CNN_with_fc_step_decay_OK", epoch=epochs)
    ...
    evaluate_model(model_mlp, test_loader, num_epochs=epochs, l2_reg=l2_reg, lr=lr, augmentations=augmentations, scheduler_type=scheduler_type, dropout_p=dropout_p)
    if i == 1:
        save_model(model_simple_cnn, "MLP_Mixer_one_cycle_OK", epoch=epochs)
    else:
        save_model(model_simple_cnn, "MLP_Mixer_step_decay_OK", epoch=epochs)



run_test(batch_size = batch_size, lr=lr, epochs=epochs, l2_reg=l2_reg, augmentations=augmentations, scheduler_type=scheduler_type, dropout_p=dropout_p, i=1)
print('-------------- SUCCESS 1 ----------------')

torch.manual_seed(42)
scheduler_type = "step_decay"  # "one_cycle" or "step_decay"
augmentations=["rotation", "translation"] # rotation "translation", "noise"
lr = 0.001
l2_reg = 0.0001
epochs = 30
...
run_test(batch_size = batch_size, lr=lr, epochs=epochs, l2_reg=l2_reg, augmentations=augmentations, scheduler_type=scheduler_type, dropout_p=dropout_p, i=2)
print('-------------- SUCCESS 2 ----------------')
